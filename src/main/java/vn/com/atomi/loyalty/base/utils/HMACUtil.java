...
public class HMACUtil {
  ...
  public static final LinkedList<String> HMACS =
      new LinkedList<String>(
          Arrays.asList(
              "UnSupport", "HmacSHA256", "HmacMD5", "HmacSHA384", "HMacSHA1", "HmacSHA512"));
   ...
   *
   * <p>The result will be represented base64-encoded string.
   *
   ...
   */
  public static String HMacBase64Encode(
      final String algorithm, final String key, final String data) {
   ...
   * combination with a secret cryptographic key.
   *
   * <p>The result will be represented hex string.
   *
   * @param algorithm A cryptographic hash function (such as MD5 or SHA-1)
   * @param key A secret cryptographic key
   * @param data The message to be authenticated
   ...
   */
  public static String HMacHexStringEncode(
      final String algorithm, final String key, final String data) {
    byte[] hmacEncodeBytes = HMacEncode(algorithm, key, data);
    if (hmacEncodeBytes == null) {
      return null;
